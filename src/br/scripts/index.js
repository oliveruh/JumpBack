import { loadMascotsPanel } from './ui.js';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateDate() {
        if (!elements.datePicker || !elements.datePicker.value) {
            ...
            state.errorMessageText = 'Por favor, escolha uma data.';
        ...
        if (isNaN(selectedDate.getTime())) {
            ...
            state.errorMessageText = 'Foi mal, a gente só tem dados até 24 de maio de 2021.';
        }
    ...
    function findJump() {
        ...
        if (elements.findButton) {
            ...
            elements.findButton.textContent = "Procurando...";
        }
